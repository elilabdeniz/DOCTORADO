...
\item Without type annotation in lambda functions or $\mathsf{mlet}$.
\item Introduce the explicit substitution in $\mathsf{mlet}$, and the substitution in lambdas.
